...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div
        className={`fixed left-0 top-0 z-30 flex h-screen flex-col border-r bg-background transition-all duration-500 ease-smooth ${
      ...
      >
        ...
        >
          ...
          >
            <ChevronRight
              className={cn(
                "h-5 w-5 transition-transform duration-500 ease-bounce-smooth",
